...
import { CheckCircle2, Package, ChevronRight, Loader2, Clock, Truck } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-luxury-black flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-[10px] uppercase tracking-[0.4em] text-luxury-gold">Verifying Transaction...</p>
      </div>
    );
  }
    ...
    <main className="pt-32 pb-20 px-6 md:px-12 bg-luxury-black min-h-screen flex items-center justify-center">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-display mb-4 tracking-[0.1em] text-primary">TRANSACTION SUCCESSFUL</h1>
          <p className="text-secondary text-sm tracking-widest uppercase mb-6">Thank you for your acquisition. Your order has been placed.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
             <span className="text-[10px] uppercase tracking-[0.4em] font-black text-secondary/60">Order Status:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 border-t border-b border-primary/10 py-10 mb-10">
          <div className="space-y-6">
            ...
            <div>
              <p className="text-[10px] text-luxury-text-secondary uppercase tracking-[0.4em] mb-2 font-black">Date</p>
              <p className="text-sm tracking-widest uppercase">{format(new Date(order.createdAt), 'MMM dd, yyyy')}</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <p className="text-[10px] text-luxury-text-secondary uppercase tracking-[0.4em] mb-2 font-black">Delivery To</p>
        ...
        <div className="mb-12">
          <h3 className="text-xs uppercase tracking-[0.4em] font-black mb-6 border-b border-primary/10 pb-4">Acquired Pieces</h3>
